          ...
          <div className="flex items-center gap-4">
            <div
              className={`p-3 rounded-full ${
                config.alarmEnabled ? "bg-green-500/20" : "bg-slate-500/20"
              }`}
            >
              <ClockIcon
                className={`h-6 w-6 ${
                  config.alarmEnabled ? "text-green-400" : "text-slate-400"
                }`}
              />
            </div>
            <div>
          ...
          >
            ...
            <SmartAlarmCard>
              <motion.button
                ...
                onClick={() =>
                  setActiveSection(
                    activeSection === "bedtime" ? null : "bedtime"
                  )
                }
            ...
            <SmartAlarmCard>
              <motion.button
                whileTap={{ scale: 0.98 }}
                onClick={() =>
                  setActiveSection(activeSection === "wake" ? null : "wake")
                }
                className="w-full flex items-center justify-between text-left"
              >
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        >
                          <motion.div
                            animate={{
                              x: config.adaptiveWakeEnabled ? 24 : 2,
                            }}
                            transition={{
                              type: "spring",
                              stiffness: 500,
                      ...
                      <p className="text-sm text-slate-400">
                        Wake you during light sleep up to{" "}
                        {config.adaptiveWindowMinutes} minutes before your alarm
                      </p>
                    </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <motion.button
                          ...
                          onClick={() => {
                            ...
                            setConfig((prev) => ({
                              ...prev,
                              sunriseEnabled: !prev.sunriseEnabled,
                            }));
                          }}
                          className={`relative w-12 h-6 rounded-full transition-colors ${
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <motion.button
                          ...
                          onClick={() => {
                            ...
                            setConfig((prev) => ({
                              ...prev,
                              sunsetEnabled: !prev.sunsetEnabled,
                            }));
                          }}
                          className={`relative w-12 h-6 rounded-full transition-colors ${
                            config.sunsetEnabled
                              ? "bg-purple-500"
                              : "bg-slate-600"
                          }`}
                        >
