    ...
    <div className="flex items-center justify-center gap-8">
      ...
      <div className="flex flex-col items-center">
        ...
        <motion.button
          whileTap={{ scale: 0.9 }}
          onClick={() => {
            const currentIndex = minutes.filter(m => m % 5 === 0).indexOf(selectedMinute);
            const nextIndex = (currentIndex + 1) % minutes.filter(m => m % 5 === 0).length;
        ...
        <motion.button
          ...
          onClick={() => {
            const currentIndex = minutes.filter(m => m % 5 === 0).indexOf(selectedMinute);
            const prevIndex = (currentIndex - 1 + minutes.filter(m => m % 5 === 0).length) % minutes.filter(m => m % 5 === 0).length;
